OC.L10N.register(
    ...
    "_1 image detected_::_{totalImages} images detected_" : ["1 Bild wurde gefunden","{totalImages} Bilder wurden gefunden"],
    "_1 image in queue_::_{queuedImages} images in queue_" : ["1 Bild in der Warteschlange","{queuedImages} Bilder in der Warteschlange"],
    ...
    "Persons" : "Personen",
    "Looking for faces in this image…" : "Es wird nach Gesichter in diesem Bild gesucht…",
    "Rename" : "Umbenennen",
    ...
    "Show all groups with the same name" : "Zeige alle Gruppen mit dem gleichen Namen",
    "Your friends have not been recognized yet" : "Ihre Freund wurden noch nicht analysiert",
    ...
    "Recommended memory for analysis is at least 1GB of RAM." : "Für die Analyse wird mindestens 1GB Arbeitsspeicher empfohlen.",
    "We are not recommending using more than 4GB of RAM memory, as we see little to no benefit." : "Es wird nicht empfohlen mehr als 4GB Arbeitsspeicher zu verwenden, da wir keine Verbesserung feststellen konnten.",
    "According to your system you can not use more than %s GB of RAM" : "Gemäß Ihrem System können Sie nicht mehr als %s GB Arbeitsspeicher verwenden.",
    ...
    "Less minimum confidence" : "Wenig Mindestvertrauen",
    "Highest minimum confidence" : "Höchstes Mindestvertrauen",
    "Memory limits" : "Speichergrenzen",
    "Assigning more RAM can improve the results, but the analysis will be slower. Limiting its use you will get results faster, but for example you can lose the discovery of smaller faces in your images." : "Die Zuweisung von mehr Arbeitsspeicher kann die Ergebnisse verbessern, aber die Analyse wird langsamer sein. Wenn Sie die Nutzung einschränken, werden Sie schneller Ergebnisse erhalten, aber Sie können z.B. die Entdeckung kleinerer Gesichter in Ihren Bildern verlieren.",
    "Use suffix as 2048 MB or 2G" : "Endung als 2048 MB oder 2G verwenden",
    "Additional settings" : "Weitere Einstellungen",
    "Show persons with a only 1 face found" : "Zeige Personen mit zu einem gefundenen Gesicht",
