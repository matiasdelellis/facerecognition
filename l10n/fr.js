OC.L10N.register(
    ...
    "_%n image was analyzed_::_%n images were analyzed_" : ["%n image a été analysée","%n images ont été analysées"],
    "Analyzing images" : "Analyse des images en cours",
    "_%n image detected_::_%n images detected_" : ["%n image détectée","%n images détectées"],
    "_%n image in queue_::_%n images in queue_" : ["%n image en attente d'analyse","%n images en attente d'analyse"],
    "The analysis is not started yet" : "L'analyse n'est pas encore commencée",
    ...
    "Persons" : "Personnes",
    "Looking for faces in this image…" : "Recherche de visages dans l'image en cours... ",
    "Rename" : "Renommer ",
