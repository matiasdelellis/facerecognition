OC.L10N.register(
    ...
    "_%n image was analyzed_::_%n images were analyzed_" : ["%nimage a été analysée","%nimages ont été analysées"],
    "Analyzing images" : "Analyse des images en cours",
    "_%n image detected_::_%n images detected_" : ["%nimage détectée","%n images détectées"],
    "_%n image in queue_::_%n images in queue_" : ["%n image en attente","%n images en attente d'analyse"],
    "Ends approximately {estimatedFinalize}" : "Se termine dans environ {estimatedFinalize}",
    ...
    "Recognize persons found" : "Reconnaître les personnes trouvées",
    "There are some persons to recognize" : "Il y a quelques personnes à reconnaître",
    ...
    "Show all groups with the same name" : "Montrer tous les groupes avec le même nom",
    ...
    "_%n image_::_%n images_" : ["%n image","%n images"],
    ...
    "It seems that you do not meet the dependencies to use the current model." : "Il semble que vous n’avez pas les dépendances pour utiliser  le modèle actuel.",
    ...
    "The sensitivity determines how different the faces can be to continue to be considered as the same person." : "La sensibilité détermine à quel point les visages peuvent être différents pour continuer à être considérés comme une seule et même personne.",
    "More sensitivity, more groups" : "Plus de sensibilité, plus de groupes",
    "Less sensitivity, less groups" : "Moins de sensibilité, moins de groupes",
    ...
    "Less minimum confidence" : "Confiance minimum la plus basse",
    "Highest minimum confidence" : "Confiance minimum la plus haute",
