OC.L10N.register(
    ...
    "_%n image was analyzed_::_%n images were analyzed_" : ["%n immagine analizzata","%n immagini analizzate"],
    "Analyzing images" : "Analisi delle immagini in corso",
    "_%n image detected_::_%n images detected_" : ["%n immagine trovata","%n immagini trovate"],
    "_%n image in queue_::_%n images in queue_" : ["%n immagine in coda","%n immagini in coda"],
    ...
    "The changes were saved. It will be taken into account in the next analysis." : "Le modifiche sono state salvate. Verrano tenute in considerazione durante la prossima analisi.",
    ...
    "The analysis is disabled. Soon all the information found for facial recognition will be removed." : "L'analisi è disabilitata. Lle informazioni sul riconoscimento facciale verranno rimosse a breve.",
    "Recognize persons found" : "Trovate persone riconosciute.",
    "There are some persons to recognize" : "Ci sono alcune persone da riconoscere.",
    ...
    "Show all groups with the same name" : "Mostra tutti i gruppi con lo stesso nome",
    ...
    "You will lose all the information analyzed, and if you re-enable it, you will start from scratch." : "Perderai tutte le informazioni analizzate, se le riattivi, iniziera l'analisi da capo.",
    ...
    "_%n image_::_%n images_" : ["%n immagine","%n immagini"],
    ...
    "Photos that are not in the gallery are also ignored" : "Anche le immagini che non sono nella galleria verrano ignorate.",
    ...
    "The minimum recommended area is %s" : "L'area minima consiglieta è %s",
    "The maximum recommended area is %s" : "L'area massima consiglieta è %s",
    "The model does not recommend an area greater than %s" : "Le aree più grandi di %s sono sconsigliate per questo modello",
    "It seems you don't have any model installed." : "Sembra tu non abbia modelli di analisi installati.",
    "It seems that you do not meet the dependencies to use the current model." : "Sembra che le dipendenze per utilizzare questo modello di analisi non siano soddisfatte.",
    ...
    "Memory assigned to PHP:" : "Memoria assegnata al PHP:",
    "Maximum memory for facial recognition:" : "Memoria massima utilizzata per riconoscimento facciale:",
    "Pdlib version:" : "Versione Pdlib:",
