OC.L10N.register(
    ...
    "_%n image was analyzed_::_%n images were analyzed_" : ["imagem foi analisadas","%nimagens foram analisadas"],
    "Analyzing images" : "Analisando imagens",
    "_%n image detected_::_%n images detected_" : ["imagem detectada","%n imagens detectadas"],
    "_%n image in queue_::_%n images in queue_" : ["imagem na fila","%nimagens na fila"],
    ...
    "Recognize persons found" : "Reconheça pessoas encontradas",
    "There are some persons to recognize" : "Existem algumas pessoas para reconhecer",
    ...
    "Show all groups with the same name" : "Mostrar todos os grupos com o mesmo nome",
    ...
    "_%n image_::_%n images_" : ["imagem","imagens"],
    ...
    "It seems that you do not meet the dependencies to use the current model." : "Parece que você não atende os requisitos para usar o modelo atual.",
    ...
    "System memory:" : "Memoria do sistema:",
    "Memory assigned to PHP:" : "Memória atribuída a PHP:",
    "Maximum memory for facial recognition:" : "Memória máxima para reconhecimento facial:",
    "Pdlib version:" : "Versão Pdlib:",
