OC.L10N.register(
    ...
    "Facial recognition is disabled for this folder" : "此文件夹的人脸识别功能被禁用",
    "See <a target=\"_blank\" href=\"{docsLink}\">documentation ↗</a>." : "查看 <a target=\"_blank\" href=\"{docsLink}\">文档 ↗</a>.",
    "Search for persons in the photos of this directory" : "在此目录的照片中搜索人脸",
    "Photos that are not in the gallery are also ignored" : "不在图库中的照片也将被忽略",
    ...
    "Show all groups with the same name" : "显示所有具有相同名称的群组",
