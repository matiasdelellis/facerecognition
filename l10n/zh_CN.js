OC.L10N.register(
    ...
    "_%n image was analyzed_::_%n images were analyzed_" : ["对 %n 张图片进行了分析"],
    "Analyzing images" : "分析图像",
    "_%n image detected_::_%n images detected_" : ["检测到图像"],
    "_%n image in queue_::_%n images in queue_" : ["队列中的图像"],
    "Ends approximately {estimatedFinalize}" : "大约在第 {estimatedFinalize} 张完成",
    ...
    "Facial recognition is disabled" : "人脸识别已被禁用",
    "Facial recognition is disabled for this folder" : "此文件夹的人脸识别功能已被禁用",
    "See <a target=\"_blank\" href=\"{docsLink}\">documentation ↗</a>." : "查看 <a target=\"_blank\" href=\"{docsLink}\">文档 ↗</a>.",
    "Search for persons in the photos of this directory" : "强制在此目录的图像中搜索人脸",
    ...
    "Analyze my images and group my loved ones with similar faces" : "分析我的图像，并用相似的面孔将我的亲友分组",
    "Looking for your recognized friends" : "寻找您已识别的亲友",
    "Show all groups with the same name" : "显示所有具有相同名称的分组",
    ...
    "Save" : "保存",
    "Sensitivity" : "灵敏度",
    "The sensitivity determines how different the faces can be to continue to be considered as the same person." : "灵敏度决定了可以将多大差别的面孔继续视为同一个人。",
    "More sensitivity, more groups" : "更高的灵敏度，意味着更多的分组",
    "Less sensitivity, less groups" : "越低的灵敏度，分组会越少",
    ...
    "Show persons with only one face found" : "显示只发现 1 张脸的人",
    "Configuration information" : "配置信息",
    "Current Model:" : "当前使用的模型",
    "Current status" : "当前状态",
    "Stopped" : "已停止"
},
"nplurals=1; plural=0;");
