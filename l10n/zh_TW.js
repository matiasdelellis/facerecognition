OC.L10N.register(
    ...
    "It seems that you do not meet the dependencies to use the current model." : "您似乎不符合使用目前模型的依賴關係。",
    "Not installed" : "未安裝",
    ...
    "System memory:" : "系統記憶體：",
    "Memory assigned to PHP:" : "分配給 PHP 的記憶體：",
    "Maximum memory for facial recognition:" : "人臉識別的最大記憶體：",
    "Pdlib version:" : "Pdlib 版本：",
    "Current model:" : "目前的模型：",
